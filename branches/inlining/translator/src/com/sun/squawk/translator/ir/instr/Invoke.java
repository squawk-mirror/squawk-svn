...
public abstract class Invoke extends StackProducer {
     ...
     */
    public final StackProducer[] getParameters() {
        return parameters;
    }

    /**
     * Calling a static method means that it will invoke <clinit> if needed.
     * Calling a virtual method means that there must be an instance of the defining class around, so the <clinit> has already been called
     */
