...
/**
 * A visitor for the targets of instructions that have targets.
 */
public interface TargetVisitor {
   
    /**
     * Visits a single given target of a given instruction.
     *
     * @param   instruction  the instruction being visited
     * @param   target      an operand of <code>instruction</code>
     */
