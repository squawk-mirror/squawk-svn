...
public class Return extends Instruction implements Mutator {
    ...
    /**
     * A return instruction empties the operand stack, and [optionally] pushes a result. 
     *  Record how many entries were implicitly popped,
     */
     private int poppedWords;
     ...
     *               a void return
     * @param poppedWords how many entries were implicitly popped by this return
     */
    public Return(StackProducer value,  int poppedWords) {
        this.value = value;
        this.poppedWords = poppedWords;
    }
    ...
    /**
     * Gets the number of entries that were implicitly popped,
     */
