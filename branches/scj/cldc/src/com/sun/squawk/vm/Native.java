...
public final class Native {
    ...
    public final static int com_sun_squawk_VM$allocateVirtualStack        = 115;
    public final static int com_sun_squawk_VM$asKlass                     = 116;
    public final static int com_sun_squawk_VM$callStaticNoParm            = 117;
    public final static int com_sun_squawk_VM$callStaticOneParm           = 118;
    public final static int com_sun_squawk_VM$copyBytes                   = 119;
    public final static int com_sun_squawk_VM$deadbeef                    = 120;
    public final static int com_sun_squawk_VM$doubleToLongBits            = 121;
    public final static int com_sun_squawk_VM$executeCIO                  = 122;
    public final static int com_sun_squawk_VM$executeCOG                  = 123;
    public final static int com_sun_squawk_VM$executeGC                   = 124;
    public final static int com_sun_squawk_VM$fatalVMError                = 125;
    public final static int com_sun_squawk_VM$finalize                    = 126;
    public final static int com_sun_squawk_VM$floatToIntBits              = 127;
    public final static int com_sun_squawk_VM$getBranchCount              = 128;
    public final static int com_sun_squawk_VM$getFP                       = 129;
    public final static int com_sun_squawk_VM$getGlobalAddr               = 130;
    public final static int com_sun_squawk_VM$getGlobalAddrCount          = 131;
    public final static int com_sun_squawk_VM$getGlobalInt                = 132;
    public final static int com_sun_squawk_VM$getGlobalIntCount           = 133;
    public final static int com_sun_squawk_VM$getGlobalOop                = 134;
    public final static int com_sun_squawk_VM$getGlobalOopCount           = 135;
    public final static int com_sun_squawk_VM$getGlobalOopTable           = 136;
    public final static int com_sun_squawk_VM$getInterruptStatus          = 137;
    public final static int com_sun_squawk_VM$getMP                       = 138;
    public final static int com_sun_squawk_VM$getPreviousFP               = 139;
    public final static int com_sun_squawk_VM$getPreviousIP               = 140;
    public final static int com_sun_squawk_VM$hasVirtualMonitorObject     = 141;
    public final static int com_sun_squawk_VM$hashcode                    = 142;
    public final static int com_sun_squawk_VM$intBitsToFloat              = 143;
    public final static int com_sun_squawk_VM$invalidateClassStateCache   = 144;
    public final static int com_sun_squawk_VM$isBigEndian                 = 145;
    public final static int com_sun_squawk_VM$isInKernel                  = 146;
    public final static int com_sun_squawk_VM$longBitsToDouble            = 147;
    public final static int com_sun_squawk_VM$math                        = 148;
    public final static int com_sun_squawk_VM$pause                       = 149;
    public final static int com_sun_squawk_VM$removeVirtualMonitorObject  = 150;
    public final static int com_sun_squawk_VM$sendInterrupt               = 151;
    public final static int com_sun_squawk_VM$serviceResult               = 152;
    public final static int com_sun_squawk_VM$setBytes                    = 153;
    public final static int com_sun_squawk_VM$setGlobalAddr               = 154;
    public final static int com_sun_squawk_VM$setGlobalInt                = 155;
    public final static int com_sun_squawk_VM$setGlobalOop                = 156;
    public final static int com_sun_squawk_VM$setPreviousFP               = 157;
    public final static int com_sun_squawk_VM$setPreviousIP               = 158;
    public final static int com_sun_squawk_VM$setupAlarmInterval          = 159;
    public final static int com_sun_squawk_VM$setupInterrupt              = 160;
    public final static int com_sun_squawk_VM$startTimer                  = 161;
