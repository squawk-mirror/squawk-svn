 ...
 * 
 * Invocations of the methods in ClockCallBack are serialized. The callback is
 * de-registered before a method in it is invoked, and the Clock blocks any
 * attempt by another thread to register another callback while control is in a
 * callback.
 */
// @SCJAllowed
public interface ClockCallBack {
     ...
     * than by ticking.) and clock has de-registered this clock event.
     * 
     * @param clock
