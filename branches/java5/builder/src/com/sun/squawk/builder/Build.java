...
//            	String phoneMeSourceRoot = "../phoneme/";
    ...
    protected void retroweaverClearMirrors(String fieldName) {
        ...
        try {
            ...
            field.setAccessible(true);
            List<NameSpace> namespaces = (List<NameSpace>) field.get(stringBuilderTranslator);
            namespaces.clear();
            t = null;
     ...
     *
     * @param   baseDir    the directory under which the "weaved" directory exists
     * @param   classesDirs    the set of directories that are searched recursively for the .class files
