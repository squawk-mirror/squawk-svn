...
public interface Socket extends LibraryImport {
...
//#endif	/* (!_POSIX_C_SOURCE || _DARWIN_C_SOURCE) */ 
     ...
     *          descriptor referencing the socket.
     */
    int connect(int socket, sockaddr_in address);
...
/*end[TRUE]*/
     ...
     *          descriptor referencing the socket.
     */
    int setSockOpt(int socket, int level, int option_name, Structure option_value, int option_len);
     ...
     *          descriptor referencing the socket.
     */
    int getSockOpt(int socket, int level, int option_name, Structure option_value, IntByReference option_len);
