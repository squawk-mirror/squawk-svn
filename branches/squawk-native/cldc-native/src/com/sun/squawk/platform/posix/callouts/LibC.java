...
public interface LibC extends LibraryImport {
     ...
     */
    int open(String name, int oflag);
     ...
     *         the error
     */
    int read(int fd, byte[] buf, int offset, int nbyte);
     ...
     */
    int write(int fd, byte[] buf, int offset, int nbyte);
     ...
     * //     };
     */
    public static abstract class stat extends Structure {
