...
rmdir /S /Q classes
mkdir classes
"%JAVA_HOME%\bin\javac" -target 1.5 -source 1.5 -d classes -g -cp %JAVA_HOME%\lib\tools.jar src\com\sun\squawk\builder\*.java src\com\sun\squawk\builder\bytecodespec\*.java src\com\sun\squawk\builder\ccompiler\*.java src\com\sun\squawk\builder\commands\*.java src\com\sun\squawk\builder\gen\*.java src\com\sun\squawk\builder\launcher\*.java src\com\sun\squawk\builder\platform\*.java src\com\sun\squawk\builder\util\*.java src\com\sun\cldc\jna\*.java src\com\sun\cldc\jna\ptr\*.java 
